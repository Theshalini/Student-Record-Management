            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                 ...
                 <a> <button id="print-button" type="button" class="btn btn-sm btn-primary"  ><span style="color: #fff;">Print</button></a>
      <script>
                    ...
                    <tbody>
                      ...
                      while($row=mysqli_fetch_array($query))
                      {
                        ...
                        <tr>
                          ...
                          <td><?php echo htmlentities($row['emisno']);?></td>
                          ...
                          <th>
                            ...
                            <button  class=" btn btn-success btn-xs edit_data2" id="<?php echo  $row['id']; ?>" title="click for edit">0View</i></button>
