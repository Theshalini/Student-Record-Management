 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="dashboard.php" class="brand-link">
    <img src="company/clglogo.jpg" alt="Leading Estate" class="brand-image img-circle elevation-3"
    style="opacity: .8">
    <span style="color:#ffffff;">&nbsp;&nbsp;&nbsp;GCWK </span>
  </a>
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      if($query->rowCount() > 0)
      {
        ...
        {    
          ?>
          <!--<h5 style="color:#ffffff;">&nbsp;&nbsp;STUDENT RECORD <br>&nbsp;&nbsp;MANAGEMENT</h5>-->
          <div class="image">
